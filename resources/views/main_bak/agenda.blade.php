                        ...
                        @foreach (DB::table('agenda')->where('role',0)->get() as $item)
                            <div class="card-agenda">
                                ...
                                <div class="agenda-info">
                                    <h6>{{ $item->tanggal }}</h6>
                                    <h3>{{ $item->judul }}</h3>
                                    <a href="/detail-agenda/{{$item->id}}" class="btn btn-warning btn-sm d-inline">Detail Agenda</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
                        ...
                        @foreach (DB::table('agenda')->where('role',1)->get() as $item)
                            <div class="card-agenda">
                                ...
                                <div class="agenda-info">
                                    <h6>{{ $item->tanggal }}</h6>
                                    <h3>{{ $item->judul }}</h3>
                                    <a href="/detail-agenda/{{$item->id}}" class="btn btn-warning btn-sm d-inline">Detail
                                        Pengumuman</a>
                                </div>
                            </div>
                        @endforeach
