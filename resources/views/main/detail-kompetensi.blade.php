...
<!-- Sambutan Kepala Sekolah -->
    ...
    <ul class="nav nav-pills mb-3 mt-5" id="pills-tab" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Sambutan Kepala Program</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Tentang TKJ</a>
        </li>
    </ul>
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            <div class="panel-sambutan">
                <div class="left-side">
                    <div class="photo"><img src="{{ URL::asset('img/p2.jpg') }}" alt=""></div>
                    <div class="name">Nama Kaprog</div>
                    <div class="position">Kepala Program Teknik Komputer Jaringan</div>
                </div>
                <div class="right-side">
 ...
 <div class="wrapper-utama" data-aos="fade-up">
                 ...
                 <div class="headline">
                     <div class="overlay">
                         <div class="news-title">
                             <div class="category-label-second">Info TKJ</div>
                             <h2><a href="">Lorem Ipsum is simply dummy text of the printing and typesetting industry</a></h2>
                             <span><i class="fas fa-clock"></i> Selasa, 18 Januari 2022 &nbsp;&nbsp; <i class="fas fa-user"></i> Administrator</span>
                         </div>
                     </div>
  ...
  <div class="wrapper-utama mt-4" data-aos="fade-up">
      ...
      <a href="/galeri" class="btn btn-success w-100"><i class="far fa-arrow-alt-circle-right"></i> Lihat Semua Album</a>
  </div>
