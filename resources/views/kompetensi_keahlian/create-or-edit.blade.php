                ...
                @else
                    ...
                    <form action="{{ route('kompetensikeahlian.update', ['id' => $data->id]) }}" method="post"
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">sambutan</label>
                            <textarea class="form-control" name="sambutan" placeholder="Masukan Konten" id="editor"
                                >{{$data->sambutan}} </textarea>
                        </div>

                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">tentang</label>
                            <textarea class="form-control" name="tentang" placeholder="Masukan Konten" id="editor2"
                                >{{$data->tentang}}</textarea>
                        </div>
                        ...
                        data-default-file="{{ url('thumbKompetensi/' . $data->thumb) }}" data-max-width="2000"
                        data-max-width="2000" />
